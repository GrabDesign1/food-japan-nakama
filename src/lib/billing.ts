...
export const SEED_PRODUCTS: SeedProduct[] = [
  // 初回紹介料・クレジット
  { code: "contact_unlock_standard", name: "通常案件・1件紹介", description: "「探している」案件1件・1相手への初回提案", billingType: "one_time", audience: "sell", effectType: "contact_unlock", priceAmount: 1100, unitLimit: 1, sortOrder: 10 },
  { code: "contact_unlock_verified_lead", name: "NAKAMA確認済み優良案件・1件紹介", description: "事務局確認済みの優良案件への初回提案", billingType: "one_time", audience: "sell", effectType: "contact_unlock_verified", priceAmount: 3300, unitLimit: 1, sortOrder: 11 },
  { code: "contact_credits_5", name: "紹介クレジット5件パック", description: "有効期限180日", billingType: "one_time", audience: "sell", effectType: "contact_credits", priceAmount: 4400, durationDays: CREDIT_PACK_EXPIRY_DAYS, unitLimit: 5, sortOrder: 12 },
  { code: "contact_credits_10", name: "紹介クレジット10件パック", description: "有効期限180日", billingType: "one_time", audience: "sell", effectType: "contact_credits", priceAmount: 7700, durationDays: CREDIT_PACK_EXPIRY_DAYS, unitLimit: 10, sortOrder: 13 },
  // 掲載オプション（売りたい）
  ...
  // 条件一致通知・公開範囲
  { code: "matched_notice_100", name: "条件一致通知", description: "条件に合う会員へメール通知（最大100件・審査後に送信）", billingType: "one_time", audience: "both", effectType: "matched_notice", priceAmount: 11000, unitLimit: 100, requiresReview: true, memberDiscountPercent: MEMBER_OPTION_DISCOUNT_PERCENT, sortOrder: 40 },
  ...
  { code: "both_reach_matched_100", name: "相手へ届けるセット", description: "注目表示7日＋条件一致通知100件", billingType: "one_time", audience: "both", effectType: "bundle", priceAmount: 22000, requiresReview: true, memberDiscountPercent: MEMBER_OPTION_DISCOUNT_PERCENT, sortOrder: 51 },
  // 相談・見積（自動決済しない）
  { code: "sell_serious_promotion_quote", name: "本気で売るセット", description: "最上部PR＋条件一致通知＋SNS紹介申込（審査・日程調整あり）", billingType: "quote", audience: "sell", effectType: "bundle", priceAmount: 55000, requiresReview: true, sortOrder: 60 },
