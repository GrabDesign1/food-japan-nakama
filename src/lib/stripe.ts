...
// 基本利用（登録・掲載・応募・メッセージ）は無料。会員特典は毎月30クレジット（繰越なし）と
...
export const PLANS: Plan[] = [
  {
    ...
    amount: 22000,
    unit: "月",
    tagline: "毎月30クレジットで、営業を積み上げる",
    features: [
      "毎月30クレジットを付与（「探している（調達したい）」案件への初回提案に使えます。繰越はありません）",
      "提案1件の消費は通常案件1クレジット・NAKAMA確認済み案件3クレジット",
      "1クレジットあたり733円（都度購入は1クレジット1,100円）",
