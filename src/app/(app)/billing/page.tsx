    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="max-w-[760px] rounded-[10px] border border-[var(--line)] bg-white px-5 py-4">
        ...
        <p className="mt-1 text-[12px] leading-6 text-[var(--ink-2)]">
          プロフィール登録、案件（販売・提供できる商品／仕入れ・調達したいもの／共創パートナー募集）の掲載、閲覧、応募、問い合わせの送信は無料です。
          届いた問い合わせへの返信は、何往復でも無料です。有料になるのは、①売り手から「仕入れ・調達したいもの」案件への初回提案（紹介料）②掲載オプション（露出・通知）③事務局への依頼、の3つです。
        </p>
      </div>
      ...
      <div className="max-w-[760px] rounded-[10px] border border-[var(--line)] bg-white px-5 py-4">
        ...
        <p className="mt-2 text-[11px] leading-5 text-[var(--muted)]">
          クレジットは「仕入れ・調達したいもの」案件への初回提案1件につき1件消費します。パックの有効期限は購入から180日です。
