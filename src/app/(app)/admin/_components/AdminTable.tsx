      ...
      >
        ...
        <div className="mt-4 rounded-[10px] border border-[var(--line)] bg-[var(--canvas)] p-4">
          ...
          <p className="mt-2 text-[11px] text-[var(--muted)]">
            銀行振込・請求書払いなどで入金を確認したら「ビジネス会員（課金中）」にします。ビジネス会員の特典は、毎月30件の提案チケット（繰越なし・1件あたり733円）と、追加チケット（1件購入）・掲載オプションの20%割引です。※手動でビジネス会員にした場合、月次チケットは自動付与されません（Stripe決済時のみ付与）。
          </p>
        </div>
