    ...
    >
      ...
      <section className="rounded-[12px] border border-[var(--green)] bg-white p-6">
        ...
        <p className="mt-3 text-[12px] leading-6 text-[var(--muted)]">
          ...
          売り手から「探している（調達したい）」案件への初回提案のみ、紹介料（通常案件1,100円・確認済み優良案件3,300円。5件・10件のまとめ買いパックもあります）がかかります。同じ案件・同じ相手との継続メッセージと、受けた問い合わせへの返信は何往復でも無料です。
        </p>
        <div className="mt-4">
      ...
      <section className="rounded-[12px] border-2 border-[#C9A053] bg-[#FDF9EF] p-6">
        ...
        <ul className="mt-3 flex flex-col gap-1.5 text-[13px] leading-6 text-[var(--ink-2)]">
          <li>・<b>毎月30件の提案チケット</b>（「探している（調達したい）」案件への初回提案に使えます。翌月への繰越はありません）</li>
          <li>・<b>1件あたり733円</b>（都度購入は1件1,100円）</li>
          <li>・追加の提案チケット（1件購入）が20%割引</li>
          <li>・掲載オプションが20%割引</li>
          <li>・Food Japan Summit ネットワークとの接点</li>
        </ul>
        <p className="mt-2 text-[11px] leading-5 text-[var(--muted)]">
          月に20件以上提案する方は、都度購入よりお得です（20件＝都度購入22,000円）。それより少ない場合は、都度購入・パックのほうが安く済みます。
          未使用分の翌月への繰越はありません。パック（5件・10件）は会員割引の対象外です。
        </p>
