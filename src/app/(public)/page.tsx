      ...
      <section className="fjn-hero" aria-labelledby="fjn-hero-title">
        ...
        <div className="fjn-hero__body">
          <div className="fjn-hero__copy">
            ...
            {/* 料金の要点。無料の面だけでなく**有料になる一点（売り手側の初回）も先に開示する**。
                有料になるのは「探している」案件への初回提案と、届いた問い合わせの初回開封の2つで、
                どちらも支払うのは売り手側。開封のほうは 2026-08-26 施行（lead-unlock-core.ts）。 */}
            <p className="fjn-hero__note">
              商品の掲載と案件の閲覧は無料です。<br />
              初回のやり取りに売り手側にクレジットがかかります。初回やり取りが始まったあとは、何往復でも無料です。
            </p>
          </div>
        </div>
