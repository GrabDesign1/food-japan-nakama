...
const STEPS = [
  ...
  { n: 3, title: "パートナーを探して問い合わせ", body: "掲載案件を検索し、気になる相手へメッセージで問い合わせます。届いた問い合わせへの返信は何往復でも無料です。売り手から「探している」案件へ最初の提案を送るときだけ、紹介料（通常案件1,100円・確認済み優良案件3,300円・税込）がかかります。" },
