...
const STEPS = [
  ...
  { n: 2, title: "プロフィール・案件を掲載", body: "自社の事業内容や、売りたい（提供したい）／探している（調達したい）／共創パートナー募集案件を掲載します。" },
  { n: 3, title: "パートナーを探して問い合わせ", body: "掲載案件を検索し、気になる相手へメッセージで問い合わせます。問い合わせの送信は無料です。紹介料がかかるのは初回の接点だけで、①「探している（調達したい）」案件へ最初の提案を送るとき（通常案件1,100円・NAKAMA確認済み案件3,300円・税込）②自社の「売りたい（提供したい）」案件に届いた問い合わせを初めて開くとき（1,100円・税込。2026年8月26日から）です。そのあとの継続メッセージは何往復でも無料です。" },
